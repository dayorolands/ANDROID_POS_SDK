...
internal class IswCashOutFragment : IswBottomSheetFragment() {
    ...
    private fun showCardFlow() {
        // create cash-out content
        val content = IswCashOutCardFlowFragment()
    ...
    companion object {
        ...
        fun newInstance(
                transaction: Transaction.IFIS,
                paymentInfo: IswPaymentInfo
        ): IswCashOutFragment {
            val fragment = IswCashOutFragment()
