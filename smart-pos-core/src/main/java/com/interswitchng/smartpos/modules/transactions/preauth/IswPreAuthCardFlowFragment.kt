...
internal class IswPreAuthCardFlowFragment: Fragment(), IswCardFlowFragment.CardFlowListener {
    ...
    private val parent: IswPreAuthFragment get() =
        parentFragment as IswPreAuthFragment


    private val preAuthViewModel: TransactionCardFlowViewModel by viewModel()
    ...
    private fun observeViewModel() {
        with(this.preAuthViewModel) {

            // set the transaction type
            setTransactionType(TransactionType.PreAuth)
    ...
    override fun processEmvResult(
        ...
        runWithInternet {
            ...
            this.preAuthViewModel.processResult(
                requireContext(),
                emvResult,
                parent.iswPaymentInfo,
                accountType,
